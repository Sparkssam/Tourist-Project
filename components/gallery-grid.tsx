...
export function GalleryGrid({ activeCategory }: GalleryGridProps) {
  ...
  const galleryItems = [
    ...
    {
      id: 11,
      src: "/stone-town-architecture.jpg",
    ...
    {
      id: 16,
      src: "/maasai-traditional-dance.jpg",
    ...
    {
      id: 23,
      src: "/man-hiking-gear-mountain.png",
    ...
    {
      id: 24,
      src: "/conservation-success-tanzania.png",
    ...
    {
      id: 27,
      src: "/man-binoculars-safari-vest.png",
    ...
    {
      id: 28,
      src: "/woman-cultural-dress-smiling.png",
